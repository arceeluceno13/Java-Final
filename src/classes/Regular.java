...
public class Regular extends UserAccount {
    ...
    public Regular(String name, String contact_number, String email, boolean accstatus, int IDnumber, int hours, double balance, String Regular, int rate) {
